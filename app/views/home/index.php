...
<body>
    ...
    <!-- Form tải file -->
    <form action="<?= BASE_URL ?>?page=file_upload" method="POST" enctype="multipart/form-data">
        <label for="file">Upload a new file:</label>
        <input type="file" name="file" id="file" required>
        <br>
        <label for="is_public">
            <input type="checkbox" name="is_public" id="is_public" value="1"> Make file public
        </label>
        <br>
                ...
                <?php foreach ($files as $file): ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <!-- Delete -->
                            <a href="<?= BASE_URL ?>?page=file_delete&id=<?= $file['id']; ?>" onclick="return confirm('Are you sure you want to delete this file?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else: ?>
